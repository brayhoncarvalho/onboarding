...
.auth-header__back { display: inline-flex; align-items: center; gap: 6px; padding: 8px 18px; border: 1.5px solid #e3edec; border-radius: 999px; background: transparent; color: #0b2528; font-family: "Instrument Sans", sans-serif; font-size: 16px; font-weight: 500; cursor: pointer; transition: background 0.15s; }
...
.auth-dd__avatar { width: 30px; height: 30px; border-radius: 50%; background: #063b3e; color: #ffffff; font-family: "Bricolage Grotesque", sans-serif; font-size: 16px; font-weight: 700; display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; letter-spacing: 0.02em; }
.auth-dd__name { font-family: "Instrument Sans", sans-serif; font-size: 16px; font-weight: 500; color: #0b2528; }
...
.auth-dd__item { width: 100%; display: flex; align-items: center; gap: 10px; padding: 10px 12px; border: none; background: transparent; border-radius: 10px; font-family: "Instrument Sans", sans-serif; font-size: 16px; font-weight: 500; color: #0b2528; cursor: pointer; text-align: left; transition: background 0.12s; }
...
.auth-dd__badge { margin-left: auto; font-size: 15px; font-weight: 600; color: #607374; background: #f0f7f7; border-radius: 999px; padding: 2px 8px; }
