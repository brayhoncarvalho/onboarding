    ...
    <main class="proposal-main">
      <div class="proposal-main__inner">
        <div class="proposal-form cls-center">
          ...
          <h1 class="cls-title">Parabens!</h1>
          <p class="cls-body">Seu pedido de emprestimo foi concluido com sucesso. O valor de <strong>{{ props.valor }}</strong> sera depositado em sua conta ate o dia <strong>{{ depositoDate }}</strong>.</p>
        </div>
      </div>
    </main>
  </div>
