...
.ds-subtitle { font-family: 'Instrument Sans', sans-serif; font-size: 16px; color: #5b6b6c; margin: 0 0 28px; }
...
.ds-doc-card__name { font-family: 'Bricolage Grotesque', sans-serif; font-size: 16px; font-weight: 700; color: #0b2528; margin: 0 0 3px; line-height: 1.3; }
.ds-doc-card__status { font-family: 'Instrument Sans', sans-serif; font-size: 16px; color: #00a87a; font-weight: 600; margin: 0; }
.ds-doc-card__more { margin-left: auto; flex-shrink: 0; background: none; border: 1.5px solid #d5e4e2; border-radius: 999px; padding: 6px 14px; font-family: 'Instrument Sans', sans-serif; font-size: 16px; font-weight: 600; color: #063b3e; cursor: pointer; white-space: nowrap; }
